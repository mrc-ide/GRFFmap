...
OUT_MEAN_DIR   <- file.path("mean_prev_prediction_avg_2_year")
OUT_MEDIAN_DIR   <- file.path("median_prev_prediction_avg_2_year")
OUT_CI_DIR   <- file.path("CI_diff_prediction_avg_2_year")
OUT_EXCEED_DIR <- file.path("exceedance_prob_avg_2_year")

dir_create(c(paste0("R_ignore/R_scripts/outputs/plots/key_k13_mutations/", OUT_MEAN_DIR),
             paste0("R_ignore/R_scripts/outputs/plots/key_k13_mutations/", OUT_MEDIAN_DIR),
             paste0("R_ignore/R_scripts/outputs/plots/key_k13_mutations/", OUT_CI_DIR),
             paste0("R_ignore/R_scripts/outputs/plots/key_k13_mutations/", OUT_EXCEED_DIR)),
           recurse = TRUE)
