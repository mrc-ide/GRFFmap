...
ggplot() + geom_raster(data = p_lower_CI %>% filter(t==2021), aes(x=x, y=y, fill = p*100)) + scale_fill_viridis_c(limits = c(0, 100)) + ggtitle("Lower from Draws")
ggplot() + geom_raster(data = p_upper_CI %>% filter(t==2021), aes(x=x, y=y, fill = p*100)) + scale_fill_viridis_c(limits = c(0, 100)) + ggtitle("Upper from Draws")
ggplot() + geom_raster(data = p_diff_CI %>% filter(t==2021), aes(x=x, y=y, fill = p*100)) + scale_fill_viridis_c(limits = c(0, 100)) + ggtitle("Diff Draws")
